...
/* package the-witness-puzzle-solver-0.1.0.0 */
#define VERSION_the_witness_puzzle_solver "0.1.0.0"
#define MIN_VERSION_the_witness_puzzle_solver(major1,major2,minor) (\
  (major1) <  0 || \
  (major1) == 0 && (major2) <  1 || \
...
#define CURRENT_COMPONENT_ID "the-witness-puzzle-solver-0.1.0.0"

#define CURRENT_PACKAGE_KEY "the-witness-puzzle-solver-0.1.0.0"
